		...
		>
			<Headless.Select
				...
				className={clsx([
					...
					// Horizontal padding
					multiple
						? 'px-[calc(calc(var(--spacing)*3.5)-1px)] sm:px-[calc(calc(var(--spacing)*3)-1px)]'
						: 'pr-[calc(calc(var(--spacing)*10)-1px)] pl-[calc(calc(var(--spacing)*3.5)-1px)] sm:pr-[calc(calc(var(--spacing)*9)-1px)] sm:pl-[calc(calc(var(--spacing)*3)-1px)]',
					// Options (multi-select)
					'[&_optgroup]:font-semibold',
					// Typography
					'text-base/6 text-black placeholder:text-zinc-500 sm:text-sm/6',
					// Border
